...
CREATE TABLE "breed" (
  "breed_of_animal_id" serial PRIMARY KEY,
  "breed_of_animal_name" text
);
...
ALTER TABLE "pet" ADD FOREIGN KEY ("breed_of_animal") REFERENCES "breed" ("breed_of_animal_id") ON DELETE CASCADE;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON service, log_of_visits, the_medicine_used, medicine, pet, purchase, provider, client, employee, anim_type, breed, post TO db_admin;
...
GRANT USAGE, SELECT ON SEQUENCE service_service_id_seq, log_of_visits_record_id_seq, the_medicine_used_medicine_used_id_seq, anim_type_anim_type_id_seq,  medicine_medicine_id_seq, pet_pet_id_seq, client_client_id_seq, employee_employee_id_seq, breed_breed_of_animal_id_seq TO veterinarian;
GRANT USAGE, SELECT ON SEQUENCE service_service_id_seq, log_of_visits_record_id_seq, anim_type_anim_type_id_seq,  pet_pet_id_seq, client_client_id_seq, breed_breed_of_animal_id_seq TO client_vet_as;
